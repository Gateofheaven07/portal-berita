...
export default async function Home() {
  ...
  const categoryMap: Record<string, { icon: string; color: string }> = {
    ...
    "Kesehatan": { icon: "⚕️", color: "bg-green-50 dark:bg-green-950" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-balance">Portal Berita Jabodetabek</h1>
      ...
      <section className="py-12 md:py-16 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Tetap Terupdate Dengan Berita Terbaru</h2>
          <p className="text-xl opacity-90 mb-8">Jangan lewatkan informasi penting dan terkini dari Jabodetabek</p>
          <Link
            href="/contact"
            className="inline-block px-8 py-3 bg-primary-foreground text-primary rounded-lg font-semibold hover:opacity-90 transition-opacity"
          >
